...
Your working directory is C:\Users\Moiz Baig\.gemini\antigravity\scratch\baig-solution\.agents\spec_miner_survey_inv_1.
...
Follow instructions in C:\Users\Moiz Baig\.gemini\antigravity\scratch\baig-solution\.agents\spec_miner_survey_inv_1\DISPATCH.md.
...
4. Pre-filled Baig Solution Company Details: Name, address, email, phone, website, tax/reg info if available.
...
Write your detailed specifications to `C:\Users\Moiz Baig\.gemini\antigravity\scratch\baig-solution\.agents\spec_miner_survey_inv_1\specs.md` and `handoff.md`.
