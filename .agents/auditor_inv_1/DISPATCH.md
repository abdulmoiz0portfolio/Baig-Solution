...
Write your audit report and verdict (`CLEAN` or `INTEGRITY VIOLATION`) to `C:\Users\Moiz Baig\.gemini\antigravity\scratch\automatixes\.agents\auditor_inv_1\audit.md` and `handoff.md`.
