...
<section class="subpage-hero text-center position-relative">
    <div class="container">
        ...
        <p class="lead text-secondary max-width-600 mx-auto">
            Create, customize, and export high-quality A4 PDF invoices instantly. Powered by live calculations and Baig Solution design system.
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="card border-0 shadow-lg rounded-4 p-4 p-md-5 bg-white invoice-card">
            ...
            <div class="invoice-watermark mt-5 pt-3 border-top text-center" style="display: none;">
                <span class="text-muted" style="font-size: 10pt; opacity: 0.6;">
                    Invoice Generated by <strong>Baig Solution</strong> | <i class="fa-solid fa-globe me-1"></i> baig-solution.vercel.app | <i class="fa-solid fa-phone me-1"></i> +92 336 6920141
                </span>
            </div>
        </div>
    </div>
...
<script>
    ...
    createApp({
        setup() {
            ...
            const notes = ref('Thank you for working with Baig Solution! Payment is due within 14 days.');
