            ...
            <div class="row align-items-start mb-4 pb-3 border-bottom header-row">
                ...
                <div class="col-md-7 mb-3 mb-md-0">
                    <div class="d-flex align-items-center mb-3">
                        <img src="assets/img/logo/icon_light.jpg" alt="Baig Solution Logo" class="me-2 rounded-3" style="width: 42px; height: 42px; object-fit: cover; border: 1px solid rgba(0,0,0,0.1);">
                        <div>
