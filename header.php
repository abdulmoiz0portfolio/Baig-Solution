    ...
    <header id="header-sticky" class="header-nav">
        <div class="container">
                ...
                <a class="navbar-brand d-flex align-items-center" href="index">
                    <img src="assets/img/logo/automatixes-logo-new.png" alt="Automatixes Logo" style="width: 320px; height: auto; object-fit: contain; margin-top: -15px; margin-bottom: -15px;">
                </a>
