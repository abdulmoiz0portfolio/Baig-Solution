...
<section class="subpage-hero text-center text-dark">
    <div class="container">
        <span class="badge bg-brand-translucent text-accent-brand mb-3 font-monospace px-3 py-2 border border-brand-50">DIGITAL ASSISTANTS</span>
        <h1 class="display-4 fw-extrabold text-dark">Autonomous AI Agents</h1>
        <div class="title-underline"></div>
        <p class="lead text-secondary mx-auto mt-4 max-w-700">
            Deploy intelligent natural language agents that train on your data to handle customer service, qualify leads, and run operations 24/7.
        </p>
    </div>
</section>
...
<section class="section-padding bg-white text-dark">
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                <span class="badge bg-brand-translucent text-accent-brand mb-3 font-monospace px-3 py-2 border border-brand-50">AGENTIC AI</span>
                <h2 class="display-6 fw-extrabold text-dark mb-4">Connect Your Custom Knowledge Bases</h2>
                <p class="text-secondary fs-5 mb-4">
                    Our AI Agents are engineered to index your PDFs, documentation files, spreadsheets, and website pages, outputting accurate, brand-aligned answers with zero hallucination.
                </p>
                <div class="row g-4">
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            <div class="icon-box me-3"><i class="fa-solid fa-file-pdf text-accent-brand"></i></div>
                            <h6 class="mb-0 fw-bold text-dark">PDF & Doc Indexing</h6>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            <div class="icon-box me-3"><i class="fa-solid fa-headset text-accent-brand"></i></div>
                            <h6 class="mb-0 fw-bold text-dark">Support Ticketing Links</h6>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            <div class="icon-box me-3"><i class="fa-solid fa-comments text-accent-brand"></i></div>
                            <h6 class="mb-0 fw-bold text-dark">Live Chat Widget Setup</h6>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            <div class="icon-box me-3"><i class="fa-solid fa-brain text-accent-brand"></i></div>
                            <h6 class="mb-0 fw-bold text-dark">Advanced RAG Pipelines</h6>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <img src="assets/img/services/ai_agents.jpg" alt="Autonomous AI Agents Dashboard representation" class="img-fluid rounded-4 border border-light shadow-sm">
            </div>
        </div>
    </div>
</section>
...
<section class="section-padding bg-warm-peach text-dark">
    <div class="container text-center max-w-700">
        <h2 class="display-6 fw-extrabold text-dark mb-3">Employ an AI Agent Today</h2>
        <p class="text-secondary fs-5 mb-4">
            Want to build a dedicated AI assistant that answers support queries or book appointments automatically? Get in touch.
        </p>
